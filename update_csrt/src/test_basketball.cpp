/**
 * @file test_basketball.cpp
 * @brief Quick test on Basketball sequence
 */
...
int main() {
    ...
    std::cout << "================================================================================" << std::endl;
    std::cout << "Testing Updated CSRT on Basketball (First 50 frames)" << std::endl;
    std::cout << "================================================================================" << std::endl;
    
    // Load ground truth
    auto gt_boxes = loadGroundTruth(base_path + "/groundtruth_rect.txt");
    std::cout << "\nLoaded " << gt_boxes.size() << " GT boxes" << std::endl;
    
    // Get image files
    std::vector<std::string> img_files;
    for (int i = 1; i <= 50 && i <= gt_boxes.size(); ++i) {
        char filename[256];
        sprintf(filename, "%s/img/%04d.jpg", base_path.c_str(), i);
    ...
    if (!tracker.initialize(frame, gt_boxes[0])) {
    ...
    std::cout << "\n================================================================================" << std::endl;
    std::cout << "Results (50 frames)" << std::endl;
    std::cout << "================================================================================" << std::endl;
